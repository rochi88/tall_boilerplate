...
trait ApiResponse
{
    ...
    private function preparedResponse($actionName): ?array
    {
        $actions = [
            ...
            'restore' => [ApiStatus::SUCCESS, Response::HTTP_OK, Messages::RESTORED_SUCCESSFULLY],
            'forceDelete' => [ApiStatus::SUCCESS, Response::HTTP_OK, Messages::DELETED_SUCCESSFULLY],
            'logout' => [ApiStatus::SUCCESS, Response::HTTP_OK, Messages::LOGGED_OUT_SUCCESSFULLY],
        ];
